...
def insert_requisition_form(data, created_by):
    ...
    """, (
        ...
        pyodbc.Binary(data.get("s_photo")) if data.get("s_photo") else None,
        ...
        data.get("s_present_address"),
        data.get("s_present_city"),
        data.get("s_present_state"),
        data.get("s_present_pincode"),
        data.get("s_contact_no"),
        data.get("s_emergency_contact_details"),
        data.get("s_emergency_city"),
        data.get("s_emergency_state"),
        data.get("s_emergency_pincode"),
        data.get("s_emergency_contact_no"),
